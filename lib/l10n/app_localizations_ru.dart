...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get salahTitle => 'Тасбих и молитвенные серии';

  @override
  String get salahSubtitle =>
      'Красивый цифровой счетчик тасбиха с предустановками зикра, пользовательскими записями и отслеживанием серий.';

  @override
  String get tasbihTitle => 'Тасбих и молитвенные серии';
  ...
  @override
  String get quranTitle => 'Коран, Кибла и Масджид';

  @override
  String get quranSubtitle =>
      'Читайте Священный Коран, находите направление Киблы и находите мечети рядом с вами — и все это в одном месте.';
  ...
  @override
  String get locationTitle => 'Включить местоположение';

  @override
  String get locationSubtitle =>
      'Нам нужно ваше местоположение для точного времени молитв, направления Киблы и поиска близлежащих мечетей.';

  @override
  String get locationButton => 'Разрешить доступ к местоположению';

  @override
  String get notificationsTitle => 'Напоминайте';

  @override
  String get notificationsSubtitle =>
      'Получайте уведомления о времени молитвы, напоминаниях о режиме фокусировки и ежедневных духовных подсказках.';
  ...
  @override
  String get screenTimeTitle => 'Доступ к экранному времени';
  ...
  String get focusModesSubtitle =>
      'Три режима, предназначенные для защиты вашего времени и внимания';
  ...
  String get focusPrayerModeDescription =>
      'Блокируйте отвлекающие приложения во время намаза для полного хушу.';
  ...
  String get focusSleepModeDescription =>
      'Защитите свой график сна и просыпайтесь для Фаджра';
  ...
  String get focusChildModeDescription =>
      'Мгновенно блокируйте приложения при передаче устройства детям';
  ...
  @override
  String get tasbihGrandTotalLabel => 'Тотал Тасбих';
